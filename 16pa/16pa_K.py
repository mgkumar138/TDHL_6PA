...
def main_script(hp):
    print('Number of PA: {}, K: {}'.format(hp['npa'], hp['K']))
    btstp = hp['btstp']
...
if __name__ == '__main__':
    ...
    hp['hidact'] = 'relu'
    totparams = np.linspace(1,67,11,dtype=int)  # TD gamma
    ...
    hp['exptname'] = 'K_16pa_{}_{}_{}ha_{}lr_{}wkm_{}dt_b{}_{}'.format(
