...
from backend_scripts.utils import find_cue, saveload, get_default_hp, savefigformats
import time as dt
...
def main_script(hp):
    print('Number of PA: {}, nHid: {}'.format(hp['npa'], hp['nhid']))
    btstp = hp['btstp']
...
if __name__ == '__main__':
    ...
    hp['hidact'] = 'relu'
    totparams = np.linspace(1,250,11)  # TD gamma
    ...
    hp['exptname'] = 'nhid_16pa_{}_{}_{}ha_{}lr_{}wkm_{}dt_b{}_{}'.format(
    ...
    ax11.set_xlabel('Expansion Ratio')
